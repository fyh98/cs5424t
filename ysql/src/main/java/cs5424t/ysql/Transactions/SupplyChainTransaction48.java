...
@Service
public class SupplyChainTransaction48 implements SupplyChainTransaction{
...
//        (c) Carrier identifier O CARRIER ID
        OrderXcnd48 lastOrder = orderRepository.findTopByWarehouseIdAndDistrictIdAndCustomerIdOrderByIdDesc(warehouseId, districtId, customerId);
